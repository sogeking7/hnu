...
public class PgpArmorHeaders extends TableImpl<PgpArmorHeaderRecord> {
     ...
     */
    @Override
    public Class<PgpArmorHeaderRecord> getRecordType() {
        return PgpArmorHeaderRecord.class;
    }

    /**
     * The column <code>public.pgp_armor_headers.key</code>.
     */
    public final TableField<PgpArmorHeaderRecord, String> KEY = createField(DSL.name("key"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.pgp_armor_headers.value</code>.
     */
    public final TableField<PgpArmorHeaderRecord, String> VALUE = createField(DSL.name("value"), SQLDataType.CLOB, this, "");

    private PgpArmorHeaders(Name alias, Table<PgpArmorHeaderRecord> aliased) {
        this(alias, aliased, new Field[] {
            DSL.val(null, SQLDataType.CLOB)
        });
    }

    private PgpArmorHeaders(Name alias, Table<PgpArmorHeaderRecord> aliased, Field<?>[] parameters) {
        this(alias, aliased, parameters, null);
    }

    private PgpArmorHeaders(Name alias, Table<PgpArmorHeaderRecord> aliased, Field<?>[] parameters, Condition where) {
